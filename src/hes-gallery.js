...
HesGallery.show = function(g, i) {
  ...
  if (this.galleries[this.currentGal].options.showImageCount && this.galleries[this.currentGal].imgPaths.length != 1) this.elements.pic_cont.dataset.howmany = `${this.currentImg + 1}/${this.galleries[g].count}`
